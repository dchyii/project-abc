...
"next_step" : based on confirmation provided in the prompt
}
""",
"setup" : """
...
""",
"initial_draft" : """
Please draft the requirements specifications solely for this section as detailed as possible, in proper text paragraphs for each point and not in json format. Proofread for grammatical errors. Any requirements that are specific to other sections of the requirements specifications shall not be included here. Any reference to yourself will be "Authority", while any reference to the supplier will be "Supplier". This draft shall be captured in the key "results" in the json. In the "reply" key, suggest to the user that you have provided a draft without including the results in your reply, and check if the user would like to amend your draft. The value to the key "next_step" shall be the word "confirmed". 
""",
"for_confirmation" : """
